...
|---|---|---|
| D1 | **POS 100% online**, sin modo offline | Sin IndexedDB, sin cola de sincronización, sin service worker. Arquitectura simple. Riesgo asumido: sin internet no se factura. |
